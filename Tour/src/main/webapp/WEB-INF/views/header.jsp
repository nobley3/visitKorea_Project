...
<body>
	<header>
	    <div class="headerBox"> <!--row1-->
	        <div class="logo">
	            <h1 class="mainlogo">
	                <a class="mainicon" href="${path}/home">
	        ...
	        <div class="munuwrap">
	            <ul class="menu">
	                <li>
	                    <a href="${path}/home">홈</a>
	                </li>
	                <li><a href="${path}/theme">테마</a></li>
	                <li><a href="${path }/locationpage">지역</a></li>
	                <li><a href="#">여행콕콕</a>
	                        <ul class="menuContent">
	                            <li><a href="${path }/hotkok">핫플콕콕</a></li>
	                            <li><a href="${path }/mycourse">AI콕콕 플래너</a></li>
	                        </ul>
	                </li>
	                <li><a href="#">여행정보</a>
						<ul class="menuContent">
							<li><a href="${path}/sights">여행지</a></li>
							<li><a href="${path}/course">여행코스</a></li>
							<li><a href="${path}/festival">축제</a></li>
							<li><a href="${path}/event">공연/행사</a></li>
						</ul>
	                </li>
	                <li><a href="${path }/map">여행지도</a></li>
	                <c:if test="${not empty sessionScope.userId}">
		                <c:if test="${user.sort == '01'}">
		                	<li><a href="${path}/admin.do">관리자페이지</a></li>
		            	</c:if>
	            	</c:if>
	            </ul>
	        </div>
        			...
        			<c:choose>
	        			<c:when test="${not empty sessionScope.userId}">
	        				<a href="${path}/mypage.do">
	        					<c:choose>
	        						<c:when test="${sessionScope.user.profileurl eq null}">
	        							<img src="https://korean.visitkorea.or.kr/resources/images/common/no_img_01.png" title="${sessionScope.user.nickname}">
	        						</c:when>
	        						<c:otherwise>
	        							<img src="${sessionScope.user.profileurl}" title="${sessionScope.user.nickname}">
	        						</c:otherwise>
	        					</c:choose>
	        				</a>
	        			</c:when>
