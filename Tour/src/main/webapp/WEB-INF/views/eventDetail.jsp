...
<body>
	...
	<section>
		...
		<c:choose>
			<c:when test="${content.eventstartdate gt currentDate}">
			    <div style="background-color:#13294b;" class="progress">진행전</div>
			</c:when>
			<c:when test="${content.eventstartdate le currentDate && currentDate le content.eventenddate}">
				<div style="background-color:#f65e57;" class="progress">진행중</div>
			</c:when>
			<c:otherwise>
	       ...
	       <div class="TitleText">
	           ...
	           <p>${content.nickName } ${content.sigunguname} ㅣ ${content.eventstartdate }  ~  ${content.eventenddate }</p>
	       ...
	       <div class="DetailBox" id="DetailBox">
				...
				<div class="MapDetailBox">
					<ul>
	                	...
	                	<li>
		                	<strong>주최</strong>
		                	<span>${content.sponsor1 }</span>
	                	</li>
	                	<li>
		                	<strong>주관</strong>
		                	<span>${content.sponsor2 }</span>
	                	</li>
					</ul>
					<ul>
						<li>
		                ...
		                <li>
		                	<strong>행사장소</strong>
		                	<span>${content.eventplace }</span>
	                	</li>
		                <li>
		                	<strong>행사시간</strong>
		                	<span>${content.playtime }</span>
		                </li>
		                <li>
		                	<strong>연령</strong>
		                	<span>${content.agelimit }</span>
		                </li>
