...
<style>
  ...
  *{
  ...
  .nj_rectour_days{
    ...
    width: 318px;
    height: 65px;
    background: url('https://korean.visitkorea.or.kr/resources/images/location/map_legend1.png')50% 50% no-repeat;
