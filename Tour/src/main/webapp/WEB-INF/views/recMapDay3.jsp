...
<style>
  ...
  *{
  ...
  .nj_rectour_days{
    ...
    width: 456px;
    height: 65px;
    background: url(http://korean.visitkorea.or.kr/resources/images/location/map_legend.png)50% 50% no-repeat;
...
<body>
		  ...
		  <div class="nj_rectour_info_scroll">
			  ...
			  <div class="nj_sump_list">
			    ...
			    <ul data-day="2">
			      ...
			      <li>
			        <div class="nj_num">1</div>
			        <img class="nj_img" src=${ spots[2].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type2">여행지</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ spots[2].title}</a>
			          <span class="nj_adrs">${ spots[2].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${spots[2].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li>
			      <li>
			        <div class="nj_num">2</div>
			        <img class="nj_img" src=${ restaurants[2].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type2">음식점</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ restaurants[2].title}</a>
			          <span class="nj_adrs">${ restaurants[2].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${restaurants[2].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li>
			      <li>
			        <div class="nj_num">3</div>
			        <img class="nj_img" src=${ spots[3].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type2">여행지</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ spots[3].title}</a>
			          <span class="nj_adrs">${ spots[3].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${spots[3].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li>
			      <li>
			        <div class="nj_num">4</div>
			        <img class="nj_img" src=${ restaurants[3].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type2">음식점</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ restaurants[3].title}</a>
			          <span class="nj_adrs">${ restaurants[3].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${restaurants[3].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li> 
			    </ul>
			    ...
			    <ul data-day="3">
			      ...
			      <li>
			        <div class="nj_num">1</div>
			        <img class="nj_img" src=${ spots[4].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type3">여행지</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ spots[4].title}</a>
			          <span class="nj_adrs">${ spots[4].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${spots[4].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li>
			      <li>
			        <div class="nj_num">2</div>
			        <img class="nj_img" src=${ restaurants[4].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type3">음식점</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ restaurants[4].title}</a>
			          <span class="nj_adrs">${ restaurants[4].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${restaurants[4].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li>
			      <li>
			        <div class="nj_num">3</div>
			        <img class="nj_img" src=${ spots[5].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type3">여행지</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ spots[5].title}</a>
			          <span class="nj_adrs">${ spots[5].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${spots[5].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li>
			      <li>
			        <div class="nj_num">4</div>
			        <img class="nj_img" src=${ restaurants[5].firstimage}>
			        <div class="nj_info">
			          <span class="nj_sort_type3">음식점</span>
			          <a class="nj_tit" href="#" onclick="displayInfo(this)">${ restaurants[5].title}</a>
			          <span class="nj_adrs">${ restaurants[5].address}</span>
			          <a class="nj_a" href="/tour/sightsDetail?contentId=${restaurants[5].contentid}"></a>
			        </div>
			        <button type="button" onclick="bookmark(this)" class="nj_bookmark" title="no"></button>
			      </li> 
			    </ul>
	...
	<script type="text/javascript">
		...
		var linePathDay2 = new kakao.maps.Polyline({
		    path: makerPathDay2,
		    strokeWeight: 3,
		    strokeColor: '#02b9c9',
		    strokeOpacity: 0.8,
		...
		var linePathDay3 = new kakao.maps.Polyline({
		    path: makerPathDay3,
		    strokeWeight: 3,
		    strokeColor: '#06b676',
		    strokeOpacity: 0.8,
		...
		linePathDay2.setMap(map);  
		linePathDay3.setMap(map);  
		...
		for (var i = 0; i < 4; i++) {
		    ...
		    var markerImageDay2 = new kakao.maps.MarkerImage(imageSrc[1], imageSize); 
		    var markerImageDay3 = new kakao.maps.MarkerImage(imageSrc[2], imageSize); 

		    var markerDay1 = new kakao.maps.Marker({
		        position: makerPathDay1[i],
		        image: markerImageDay1
		    });
		    var markerDay2 = new kakao.maps.Marker({
		        position: makerPathDay2[i],
		        image: markerImageDay2
		    });
		    var markerDay3 = new kakao.maps.Marker({
		        position: makerPathDay3[i],
		        image: markerImageDay3
		    });

		    markerDay1.setMap(map);  
		    markerDay2.setMap(map); 
		    markerDay3.setMap(map); 
