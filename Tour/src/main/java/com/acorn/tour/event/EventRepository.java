...
public class EventRepository {
	...
	public Integer totalCnt(int sidoCode) {
		...
		if(sidoCode == 0) {
			sql = "select count(*) from contentInfoTbl where contenttypeid = '15' and cat2 = 'A0208'" ;
		}else {
			sql = "select count(*) from contentInfoTbl where contenttypeid = '15' and cat2 = 'A0208' and sidoCode = " + sidoCode;
		}
	...
	public ArrayList<ContentDTO> selectAllLatest(int startList, int endList, int sidoCode) {
		...
		if(sidoCode == 0) {
			sql += "where contenttypeid = '15' and cat2 = 'A0208'" ;
		}else {
			sql += "where contenttypeid = '15' and cat2 = 'A0208' and sidoCode = " + sidoCode;
		}
	...
	public ArrayList<ContentDTO> distanceAll(int sidoCode) {
		...
		if(sidoCode == 0) {
			sql = "select contentid, mapx, mapy from contentInfoTbl where contenttypeid = '15' and cat2 = 'A0208'";
		}else {
			sql = "select contentid, mapx, mapy from contentInfoTbl where contenttypeid = '15' and cat2 = 'A0208' and sidoCode = " + sidoCode;
		}
	...
	// 상세페이지에 표출할 내용
	public EventDTO selectOne(String contentId) {
		Connection con = null;
		PreparedStatement pst = null;
		ResultSet rs = null;
		...
		try {
			...
			if(rs.next()) {
			    ...
			    content = new EventDTO(contentid,title,sidoCode,nickName,sigunguCode,sigunguname,address,tel, mapx, mapy,
