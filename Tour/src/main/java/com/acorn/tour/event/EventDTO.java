...
public class EventDTO {
    ...
    // 최신순, 인기순 DTO 여행지
	public EventDTO(String contentid, String title, int sidoCode, String nickName,
	...
	// 거리 계산을 위한 DTO
	public EventDTO(String contentid, String mapx, String mapy) {
		super();
		this.contentid = contentid;
		this.mapx = mapx;
		this.mapy = mapy;
	...
	// 거리별 정렬을 위한 DTO
	public EventDTO(String contentid, double distance) {
		super();
		this.contentid = contentid;
		this.distance = distance;
	}
	// 거리순 DTO 여행지
	public EventDTO(String contentid, String title, int sidoCode, String nickName, String sigunguCode,
	...
	// 상세페이지 DTO
	public EventDTO(String contentid, String title, int sidoCode, String nickName, String sigunguCode, String sigunguname, String address,
