...
public class ContentDTO {
    ...
    // 최신순, 인기순 DTO 여행지
	public ContentDTO(String contentid, String title, int sidoCode, String nickName,
	...
	public ContentDTO( String contentid, String title, int sidoCode, String nickName,
			...
			String firstimage, String eventstartdate, String eventenddate) {
	...
	// 거리 계산을 위한 DTO
	public ContentDTO(String contentid, String mapx, String mapy) {
		super();
		this.contentid = contentid;
		this.mapx = mapx;
		this.mapy = mapy;
	...
	// 거리별 정렬을 위한 DTO
	public ContentDTO(String contentid, double distance) {
		super();
		this.contentid = contentid;
		this.distance = distance;
	}
	// 거리순 DTO 여행지
	public ContentDTO(String contentid, String title, int sidoCode, String nickName, String sigunguCode,
	...
	// 거리순 DTO 축제/공연/행사
	public ContentDTO(String contentid, String title, int sidoCode, String nickName, String sigunguCode,
			String sigunguname, String firstimage, double distance, String eventstartdate, String eventenddate ) {
		super();
		this.contentid = contentid;
		this.title = title;
		this.sidoCode = sidoCode;
	...
	// 이미지 DTO
	public ContentDTO(String imgid, String contentid, String imgurl, String imgnum) {
		super();
		this.imgid = imgid;
		this.contentid = contentid;
		this.imgurl = imgurl;
